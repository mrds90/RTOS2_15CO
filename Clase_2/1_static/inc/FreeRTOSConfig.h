 ...
 * header file. */
void sysAssert_Report_Hang( bool condicion, int line, const char* fcn );  //<-- SHOULD BE IN .H
void sysAssert_Hang( bool condicion, int line, char* fcn );         //<-- SHOULD BE IN .H
#define configASSERT( x )   sysAssert_Report_Hang( x, __LINE__, __FUNCTION__ )
